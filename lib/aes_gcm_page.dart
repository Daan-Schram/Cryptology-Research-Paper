...
class AESPageGCM extends StatefulWidget {

  const AESPageGCM({key}) : super(key: key);

  @override
  _AESPageGCMState createState() => _AESPageGCMState();
}

class _AESPageGCMState extends State<AESPageGCM> {
